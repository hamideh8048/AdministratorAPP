                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                                  ...
                                  imageBuilder: (context, imageProvider) => Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(UserModel.comapnyLogo),
                                        fit: BoxFit.fill,
                                      ),
                                    ),
                                  ),
                            ...
                            Text("  شرکت "+UserModel.comapnyName,
                              style: Theme.of(context).textTheme.bodyText1!.copyWith(
                            ...
                            Text("کد شرکت : " + UserModel.comapnyCode,
                              style: Theme.of(context).textTheme.bodyText1!.copyWith(
          ...
          child: Column(
            children: [
              ...
              TextButton(
                ...
                style: OutlinedButton.styleFrom(padding: EdgeInsets.only(bottom: 24.sp)),
